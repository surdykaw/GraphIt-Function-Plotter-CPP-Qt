...
const int GRAPH_LAYER_WIDTH = 20001;   // YOU SHOULD NOT CHANGE THESE VALUES
const int GRAPH_LAYER_HEIGHT = 20001;  // DUE TO DIRECT DEPENDENCIES BASED ON THEM
...
void GraphLayer::setupGraphLyr(QWidget *graphLayer) {
    ...
    // AXIS ARROWS
    rightPixArr = QPixmap("rsc/mainAxArrRight.png");
    upPixArr = QPixmap("rsc/mainAxArrUp.png");
...
void GraphLayer::paintEvent(QPaintEvent *evt) {
    painter.begin(this);
    painter.setPen(p1);
